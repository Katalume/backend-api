...
const BILLING_RECONCILIATION_ENABLED = booleanValue('BILLING_RECONCILIATION_ENABLED', false);
...
if (BILLING_RECONCILIATION_ENABLED && !BILLING_ENABLED) {
    throw new Error('BILLING_RECONCILIATION_ENABLED requires BILLING_ENABLED=true');
}
if (BILLING_ENABLED && (
...
module.exports = {
    ...
    BILLING_RECONCILIATION_INTERVAL_MINUTES: positiveInt(
        'BILLING_RECONCILIATION_INTERVAL_MINUTES',
        60,
        { min: 5, max: 1440 }
    ),
    BILLING_RECONCILIATION_BATCH_SIZE: positiveInt(
